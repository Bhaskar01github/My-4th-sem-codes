...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 22 15:28:40 2023
...
kmeans = KMeans(n_clusters=4)                  # from the elbow method we could see that the after x=4 the inertia is tending to constant so the proper no. of clusters will be 4
kmeans.fit(data)
...
print(centroid)       
new=input("enter the no of matches and injuries(no of matches,injuries): ").split(",")
